...
TEST_SOURCE = "cm.txt"  # The name of a text file of a string-ified list for testing. To avoid unnecessarily hitting Twitter API. You can use the included testcorpus.txt, if needed.
...
TWEET_ACCOUNT = "fullcommubot"  # The name of the account you're tweeting to.
